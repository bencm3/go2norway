...
const APP_FILES=['./','./index.html','./go2no.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./weather-icons/rain-color.png','./weather-icons/rain-gray.png','./weather-icons/storm-color.png','./weather-icons/storm-gray.png','./weather-icons/sun-color.png','./weather-icons/sun-gray.png','./weather-icons/temp-cold.png','./weather-icons/temp-hot.png','./weather-icons/temp-neutral.png','./weather-icons/wind-color.png','./weather-icons/wind-gray.png','./weather-icons/refresh-missing.png','./action-logbook-clean.svg'];
